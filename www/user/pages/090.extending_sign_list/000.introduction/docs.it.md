...
* file di font esportati da tksesh (file .tml)
* file di font provenienti da GNU Font Utilities (file .bzr). Entrambi i tipi di file possono essere modificati con il software fontedit, incluso in tksesh. Tuttavia, questo è di scarso interesse per l'utente generico.
